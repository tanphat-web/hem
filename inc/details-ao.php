					...
					<form action="cart.php?giohang&id=<?php echo $row_product_details['product_id'];?>" method="POST">
						<div class="size" style="padding:5px 0;">
							...
							<div class="size-items">
								<p>
									<input style="opacity:0;" type="radio" name="radio" id="S" value="S">
									<label for="S">S (55 - 60kg)</label>
								</p>
								<p class="">
									<input style="opacity:0;" type="radio" name="radio" value="M" id="M">
									<label for="M">M (60 - 67kg)</label>
								</p>
								<p class="">
									<input style="opacity:0;" type="radio" name="radio" value="L" id="L">
									<label for="L">L (66 - 75kg)</label>
								</p>
								<p class="">
									<input style="opacity:0;" type="radio" name="radio" value="XL" id="XL">
									<label for="XL">XL (75 - 88kg)</label>
								</p>
							</div>
							<div class="promotion">
